...
HD_PWD='/home/matt/csm152a/lab_4_basys/lab_4_basys.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mnist_network.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mnist_network.tcl -notrace
