...
#
# Generated by export_simulation on Tue Mar 03 20:02:56 PST 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_input_weights_13.sh' script.

./blk_mem_input_weights_13.sh -reset_run
...
./blk_mem_input_weights_13.sh -noclean_files

For more information on the script, please type './blk_mem_input_weights_13.sh -help'.
