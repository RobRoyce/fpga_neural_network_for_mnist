...
#
# Generated by export_simulation on Sat Mar 07 17:57:39 PST 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_input_weights_7.sh' script.

./blk_mem_input_weights_7.sh -reset_run
...
./blk_mem_input_weights_7.sh -noclean_files

For more information on the script, please type './blk_mem_input_weights_7.sh -help'.
