...
#
# Generated by export_simulation on Wed Mar 04 17:49:35 PST 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_input_weights_5.sh' script.

./blk_mem_input_weights_5.sh -reset_run
...
./blk_mem_input_weights_5.sh -noclean_files

For more information on the script, please type './blk_mem_input_weights_5.sh -help'.
