...
#
# Generated by export_simulation on Tue Mar 03 19:58:46 PST 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_input_weights_10.sh' script.

./blk_mem_input_weights_10.sh -reset_run
...
./blk_mem_input_weights_10.sh -noclean_files

For more information on the script, please type './blk_mem_input_weights_10.sh -help'.
