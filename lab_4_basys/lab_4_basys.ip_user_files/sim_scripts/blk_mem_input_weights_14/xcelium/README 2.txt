...
#
# Generated by export_simulation on Sat Mar 07 17:56:30 PST 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_input_weights_14.sh' script.

./blk_mem_input_weights_14.sh -reset_run
...
./blk_mem_input_weights_14.sh -noclean_files

For more information on the script, please type './blk_mem_input_weights_14.sh -help'.
