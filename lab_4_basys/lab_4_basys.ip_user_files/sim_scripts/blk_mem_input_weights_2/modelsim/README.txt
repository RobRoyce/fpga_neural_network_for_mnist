...
#
# Generated by export_simulation on Wed Mar 04 23:23:48 PST 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_input_weights_2.sh' script.

./blk_mem_input_weights_2.sh -reset_run
...
./blk_mem_input_weights_2.sh -noclean_files

For more information on the script, please type './blk_mem_input_weights_2.sh -help'.
