...
#
# Generated by export_simulation on Wed Mar 04 23:57:19 PST 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_input_weights_11.sh' script.

./blk_mem_input_weights_11.sh -reset_run
...
./blk_mem_input_weights_11.sh -noclean_files

For more information on the script, please type './blk_mem_input_weights_11.sh -help'.
